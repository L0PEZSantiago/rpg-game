    ...
    npcs: [
      {
        ...
        riddlePool: [
          ...
          },
          {
            ...
            question: 'Plus tu m enleves, plus je deviens grand. Qui suis-je ?',
            options: [
            ...
            failText: 'Iria marque une croix sur ton carnet. Occasion manquee.',
            reward: {
              gold: 42,
              materials: { resin: 2 },
              revealSecretPortal: true,
          ...
          },
          {
            ...
            successText: 'Iria t offre un mot-cle et le secret s ouvre.',
    ...
    npcs: [
      {
        ...
        y: 2,
        portrait: WIZZARD_ASSET,
        dialogue: 'Tu as trouve une zone secrete. Ici, chaque erreur coute cher.',
      },
    ],
    resources: [
