...
export const MAPS = {
  ashen_meadow: {
    ...
    npcs: [
      ...
      {
        id: 'npc_bone_collector',
        name: 'Orin l\'Ossuaire',
        role: 'quest',
        spawnChance: 1.0,
        x: 12,
        y: 1,
        portrait: KNIGHT_ASSET,
        dialogue: 'Les ossements épars valent plus qu\'on ne croit, si on sait les trier.',
      },
    ],
    resources: [
  ...
  obsidian_citadel: {
    ...
    npcs: [
      ...
      {
        id: 'npc_obsidian_guardian',
        name: 'Gardien d\'obsidienne',
        role: 'lore',
        spawnChance: 0.65,
        x: 5,
        y: 7,
        portrait: WIZZARD_ASSET,
        dialogue: 'Je veille sur ce passage depuis des siècles. Prouve ta valeur.',
        riddlePool: [
          {
            id: 'riddle_obs_1',
            question: 'Je suis noir comme la nuit, dur comme le roc, forgé par le feu. Les anciens me portaient en bijou. Qui suis-je ?',
            options: [
              { id: 'obsidian', text: 'L\'obsidienne' },
              { id: 'coal', text: 'Le charbon' },
              { id: 'iron', text: 'Le fer noir' },
            ],
            correctOptionId: 'obsidian',
            successText: 'Le Gardien s\'incline. Un passage oublié se révèle dans l\'obscurité.',
            failText: 'Le Gardien secoue la tête. Ce passage reste fermé pour toi.',
            reward: { gold: 75, materials: { obsidian_fragment: 2 }, revealSecretPortal: true },
          },
          {
            id: 'riddle_obs_2',
            question: 'Je grandis dans le noir sans jamais voir la lumière. Plus on me creuse, plus je remonte vers toi. Qui suis-je ?',
            options: [
              { id: 'root', text: 'Une racine' },
              { id: 'mine', text: 'Un puits de mine' },
              { id: 'secret', text: 'Un secret' },
            ],
            correctOptionId: 'mine',
            successText: 'Les profondeurs te révèlent leur chemin caché.',
            failText: 'L\'obscurité reprend le dessus. Aucune seconde chance.',
            reward: { gold: 78, materials: { ore: 3 }, revealSecretPortal: true },
          },
          {
            id: 'riddle_obs_3',
            question: 'On me détruit pour me rendre plus fort. On me refroidit pour que je tranche. Qui suis-je ?',
            options: [
              { id: 'blade', text: 'Une lame forgée' },
              { id: 'ice', text: 'La glace' },
              { id: 'bone', text: 'Un os' },
            ],
            correctOptionId: 'blade',
            successText: 'La forge ancienne s\'illumine. Un passage est apparu.',
            failText: 'La forge reste éteinte. Ce n\'était pas la bonne réponse.',
            reward: { gold: 80, materials: { bone_dust: 2 }, revealSecretPortal: true },
          },
        ],
      },
      {
        id: 'npc_forge_ascetic',
        name: 'Forgeron Ardent',
        role: 'quest',
        spawnChance: 1.0,
        x: 3,
        y: 1,
        portrait: ROGUE_ASSET,
        dialogue: 'Un objet qui n\'a pas atteint son apogée n\'est qu\'une promesse non tenue.',
      },
      {
        id: 'npc_cartographer_apprentice',
        name: 'Tomas l\'Arpenteur',
        role: 'quest',
        spawnChance: 1.0,
        x: 10,
        y: 1,
        portrait: WIZZARD_ASSET,
        dialogue: 'Iria parle d\'un sanctuaire baigné de lune. Je voudrais le voir de mes propres yeux.',
      },
    ],
    resources: [
    ...
    enemies: [
      ...
      { id: 'e_obs_5', templateId: 'obsidian_reaper', x: 3, y: 6 },
    ],
  ...
  // ── Nouvelles maps (niveaux 15-27) ────────────────────────────────────────
  crystal_abyss: {
    id: 'crystal_abyss',
    name: 'Abysses de cristal',
    levelRange: '15-17',
    isSecret: false,
    background: '/assets/Environment/Tilesets/Wall_Variations.png',
    width: 16,
    height: 12,
    start: { x: 1, y: 1 },
    exit: { x: 14, y: 10, targetMapId: 'void_labyrinth' },
    secretPortal: {
      x: 7,
      y: 5,
      targetMapId: 'lunar_shrine',
    ...
    levers: [
      {
        ...
        x: 3,
        y: 6,
        opensWalls: [{ x: 3, y: 7 }, { x: 4, y: 7 }],
      },
    ],
    npcs: [
      {
        id: 'npc_crystal_sage',
        name: 'Sage des cristaux',
        role: 'healer',
        spawnChance: 0.7,
        x: 2,
        y: 2,
        portrait: WIZZARD_ASSET,
        dialogue: 'Les cristaux absorbent la douleur. Et l\'espoir aussi.',
      },
      {
        id: 'npc_crystal_merchant',
        name: 'Marchande errante',
        role: 'merchant',
        spawnChance: 0.5,
        x: 5,
        y: 2,
        portrait: ROGUE_ASSET,
        dialogue: 'Les reliques des abysses valent plus que tu ne le penses.',
      },
      {
        id: 'npc_crystal_specter',
        name: 'Spectre cristallin',
        role: 'lore',
        spawnChance: 0.70,
        x: 7,
        y: 3,
        portrait: WIZZARD_ASSET,
        dialogue: 'Les cristaux capturent la lumière et les âmes. Peut-être la tienne aussi.',
        riddlePool: [
          {
            id: 'riddle_crys_1',
            question: 'Je reflète tout ce qu\'on me montre sans jamais montrer ma propre face. Je brise en mille morceaux mais je reste entier. Qui suis-je ?',
            options: [
              { id: 'mirror', text: 'Un miroir' },
              { id: 'crystal', text: 'Un cristal' },
              { id: 'truth', text: 'La vérité' },
            ],
            correctOptionId: 'crystal',
            successText: 'Le spectre s\'évanouit. Une brèche lumineuse apparaît dans l\'abyssse.',
            failText: 'Les cristaux absorbent ta réponse. Aucune réflexion ne t\'aidera.',
            reward: { gold: 105, materials: { ether_drop: 2, obsidian_fragment: 1 }, revealSecretPortal: true },
          },
          {
            id: 'riddle_crys_2',
            question: 'Plus je suis profond, plus je suis transparent. Je cache les monstres que je révèle aussi. Qui suis-je ?',
            options: [
              { id: 'abyss', text: 'L\'abyssse' },
              { id: 'glass', text: 'Le verre' },
              { id: 'water', text: 'L\'eau' },
            ],
            correctOptionId: 'abyss',
            successText: 'L\'abyssse ouvre un oeil. Un portail secret scintille.',
            failText: 'Les profondeurs te rejettent. Une seule chance était offerte.',
            reward: { gold: 108, materials: { boss_shard: 1, ether_drop: 1 }, revealSecretPortal: true },
          },
        ],
      },
    ],
    resources: [
      { id: 'abyss_ore_1', type: 'ore', x: 4, y: 8, charges: 3 },
      { id: 'abyss_ore_2', type: 'ore', x: 12, y: 4, charges: 3 },
      { id: 'abyss_herb_1', type: 'herb', x: 9, y: 8, charges: 3 },
      { id: 'abyss_tree_1', type: 'tree', x: 7, y: 9, charges: 2 },
    ],
    chests: [
      { id: 'chest_abyss_1', x: 5, y: 9, rarityBias: 'epic' },
      { id: 'chest_abyss_2', x: 12, y: 2, rarityBias: 'legendary' },
      { id: 'chest_abyss_3', x: 13, y: 7, rarityBias: 'epic' },
    ],
    enemies: [
      { id: 'e_abyss_1', templateId: 'void_wraith', x: 5, y: 5 },
      { id: 'e_abyss_2', templateId: 'abyss_crawler', x: 8, y: 4 },
      { id: 'e_abyss_3', templateId: 'crystal_golem', x: 10, y: 6 },
      { id: 'e_abyss_4', templateId: 'void_wraith', x: 12, y: 8 },
      { id: 'e_abyss_5', templateId: 'abyss_crawler', x: 6, y: 8 },
    ],
    boss: { id: 'boss_abyss', templateId: 'boss_crystal_sovereign', x: 13, y: 9 },
    tiles: [
      '################',
      '#..............#',
      '#.###.....###..#',
  ...
  void_labyrinth: {
    ...
    height: 12,
    start: { x: 1, y: 1 },
    exit: { x: 14, y: 10, targetMapId: 'ruined_colosseum' },
    secretPortal: {
      x: 8,
      y: 6,
      targetMapId: 'lunar_shrine',
    ...
    npcs: [
      {
        ...
        y: 3,
        portrait: WIZZARD_ASSET,
        dialogue: 'Le vide ne ment pas. Il révèle ce que tu refuses de voir.',
        riddlePool: [
          {
            id: 'riddle_void_1',
            question: 'Je suis partout mais on ne me voit pas. Je prends tout sans jamais avoir de forme. Qui suis-je ?',
            options: [
              { id: 'void', text: 'Le vide' },
              { id: 'shadow', text: 'L\'ombre' },
              { id: 'air', text: 'L\'air' },
            ],
            correctOptionId: 'void',
            successText: 'L\'Oracle trace une rune. Un portail secret s\'ouvre dans le vide.',
            failText: 'L\'Oracle se tait. Le vide reprend tout.',
            reward: { gold: 110, materials: { ether_drop: 2, boss_shard: 1 }, revealSecretPortal: true },
          },
          {
            id: 'riddle_void_2',
            question: 'On me cherche toute une vie mais on ne me trouve qu\'à la fin. Qui suis-je ?',
            options: [
              { id: 'death', text: 'La mort' },
              { id: 'peace', text: 'La paix' },
              { id: 'meaning', text: 'Le sens' },
            ],
            correctOptionId: 'meaning',
            successText: 'L\'Oracle approuve. Une faille s\'ouvre dans le labyrinthe.',
            failText: 'L\'Oracle secoue la tête. Le passage reste fermé.',
            reward: { gold: 115, materials: { obsidian_fragment: 3 }, revealSecretPortal: true },
          },
        ],
      },
      {
        id: 'npc_void_hunter',
        name: 'Kestra la Traqueuse',
        role: 'quest',
        spawnChance: 1.0,
        x: 10,
        y: 1,
        portrait: ROGUE_ASSET,
        dialogue: 'Le Héraut du Vide m\'a échappé trop souvent. Cette fois, il ne repartira pas.',
      },
    ],
    resources: [
      { id: 'void_ore_1', type: 'ore', x: 11, y: 3, charges: 3 },
      { id: 'void_herb_1', type: 'herb', x: 6, y: 7, charges: 3 },
      { id: 'void_herb_2', type: 'herb', x: 13, y: 8, charges: 2 },
      { id: 'void_tree_1', type: 'tree', x: 4, y: 9, charges: 2 },
    ],
    chests: [
      { id: 'chest_void_1', x: 4, y: 4, rarityBias: 'legendary' },
      { id: 'chest_void_2', x: 12, y: 9, rarityBias: 'epic' },
      { id: 'chest_void_3', x: 7, y: 2, rarityBias: 'legendary' },
    ],
    enemies: [
      { id: 'e_void_1', templateId: 'void_wraith', x: 5, y: 4 },
      { id: 'e_void_2', templateId: 'shadow_stalker', x: 9, y: 5 },
      { id: 'e_void_3', templateId: 'void_wraith', x: 11, y: 7 },
      { id: 'e_void_4', templateId: 'abyss_crawler', x: 7, y: 8 },
      { id: 'e_void_5', templateId: 'crystal_golem', x: 13, y: 5 },
      { id: 'e_void_6', templateId: 'shadow_stalker', x: 4, y: 7 },
    ],
    boss: { id: 'boss_void', templateId: 'boss_void_harbinger', x: 14, y: 9 },
    tiles: [
      '################',
      '#..............#',
      '#.####.##.####.#',
  ...
  ruined_colosseum: {
    ...
    height: 12,
    start: { x: 1, y: 1 },
    exit: { x: 14, y: 10, targetMapId: 'shadow_spire' },
    secretPortal: {
      x: 8,
      y: 1,
      targetMapId: 'lunar_shrine',
    ...
    levers: [
      {
        ...
        x: 4,
        y: 5,
        opensWalls: [{ x: 5, y: 4 }, { x: 5, y: 5 }, { x: 5, y: 6 }],
      },
    ],
    npcs: [
      {
        id: 'npc_colosseum_healer',
        name: 'Médecin de l\'arène',
        role: 'healer',
        spawnChance: 0.75,
        x: 2,
        y: 2,
        portrait: KNIGHT_ASSET,
        dialogue: 'Beaucoup tombent ici. Peu se relèvent. Soigne-toi bien.',
      },
      {
        id: 'npc_arena_warden',
        name: 'Gardien de l\'arène',
        role: 'lore',
        spawnChance: 0.70,
        x: 8,
        y: 5,
        portrait: KNIGHT_ASSET,
        dialogue: 'Seuls les plus dignes voient ce que le Colisée cache derrière ses gradins.',
        riddlePool: [
          {
            id: 'riddle_colo_1',
            question: 'Dans l\'arène, on se bat sans arme. On gagne sans adversaire. On triomphe en perdant. De quoi s\'agit-il ?',
            options: [
              { id: 'honor', text: 'L\'honneur' },
              { id: 'sacrifice', text: 'Le sacrifice' },
              { id: 'cowardice', text: 'La lâcheté' },
            ],
            correctOptionId: 'sacrifice',
            successText: 'Le Gardien s\'écarte. Un passage interdit s\'ouvre dans les gradins.',
            failText: 'Le Gardien frappe le sol de son bouclier. Seuls les vrais guerriers passent.',
            reward: { gold: 120, materials: { boss_shard: 1, ore: 3 }, revealSecretPortal: true },
          },
          {
            id: 'riddle_colo_2',
            question: 'Je tombe mais ne meurs jamais. Je saigne mais reste debout. On m\'enterre sous les vivats. Qui suis-je ?',
            options: [
              { id: 'champion', text: 'Le champion vaincu' },
              { id: 'flag', text: 'L\'étendard' },
              { id: 'legend', text: 'La légende' },
            ],
            correctOptionId: 'legend',
            successText: 'La légende du Colisée t\'ouvre un couloir secret.',
            failText: 'La foule imaginaire siffle. Ce n\'était pas la bonne réponse.',
            reward: { gold: 118, materials: { obsidian_fragment: 3 }, revealSecretPortal: true },
          },
        ],
      },
    ],
    resources: [
      { id: 'colo_ore_1', type: 'ore', x: 3, y: 8, charges: 4 },
      { id: 'colo_tree_1', type: 'tree', x: 12, y: 3, charges: 3 },
      { id: 'colo_herb_1', type: 'herb', x: 11, y: 8, charges: 3 },
    ],
    chests: [
      { id: 'chest_colo_1', x: 4, y: 9, rarityBias: 'legendary' },
      { id: 'chest_colo_2', x: 13, y: 4, rarityBias: 'epic' },
      { id: 'chest_colo_3', x: 6, y: 2, rarityBias: 'legendary' },
    ],
    enemies: [
      { id: 'e_colo_1', templateId: 'shadow_stalker', x: 4, y: 5 },
      { id: 'e_colo_2', templateId: 'crystal_golem', x: 9, y: 4 },
      { id: 'e_colo_3', templateId: 'rune_sentinel', x: 11, y: 6 },
      { id: 'e_colo_4', templateId: 'void_wraith', x: 5, y: 8 },
      { id: 'e_colo_5', templateId: 'shadow_stalker', x: 12, y: 7 },
      { id: 'e_colo_6', templateId: 'abyss_crawler', x: 9, y: 9 },
    ],
    boss: { id: 'boss_colo', templateId: 'boss_colosseum_champion', x: 14, y: 9 },
    tiles: [
      '################',
      '#..............#',
      '#.##.######.##.#',
  ...
  shadow_spire: {
    ...
    npcs: [
      ...
      {
        id: 'npc_shadow_respec',
        name: 'Mystique de l\'ombre',
        role: 'respec',
        spawnChance: 0.45,
        x: 5,
        y: 9,
        portrait: WIZZARD_ASSET,
        dialogue: 'L\'ombre remodèle tout ce qu\'elle touche.',
      },
      {
        id: 'npc_shadow_riddle',
        name: 'Ombre parlante',
        role: 'lore',
        spawnChance: 0.65,
        x: 11,
        ...
        riddlePool: [
          {
            id: 'riddle_spire_1',
            question: 'Je n\'existe que lorsque la lumière est là, mais je disparais quand on tente de me saisir. Je vous suis partout. Qui suis-je ?',
            options: [
              { id: 'shadow', text: 'L\'ombre' },
              { id: 'reflection', text: 'Le reflet' },
          ...
          {
            id: 'riddle_spire_2',
            question: 'Je suis noir le jour et invisible la nuit. Je frôle sans toucher et touche sans frôler. Qui suis-je ?',
            options: [
              { id: 'shadow', text: 'L\'ombre de la flèche' },
              { id: 'night', text: 'La nuit' },
              { id: 'fear', text: 'La peur' },
            ],
            correctOptionId: 'shadow',
    ...
    resources: [
      { id: 'spire_ore_1', type: 'ore', x: 11, y: 2, charges: 4 },
      { id: 'spire_ore_2', type: 'ore', x: 4, y: 5, charges: 3 },
      { id: 'spire_herb_1', type: 'herb', x: 13, y: 8, charges: 3 },
    ...
    boss: { id: 'boss_spire', templateId: 'boss_shadow_monarch', x: 13, y: 1 },
    tiles: [
      '################',
      '#..............#',
      '#.###.....###..#',
  ...
  nether_citadel: {
    ...
    height: 12,
    start: { x: 1, y: 1 },
    exit: { x: 14, y: 10, targetMapId: 'onyx_throne' },
    secretPortal: {
      x: 8,
      y: 10,
      targetMapId: 'lunar_shrine',
    ...
    levers: [
      {
        ...
        x: 5,
        y: 5,
        opensWalls: [{ x: 6, y: 5 }, { x: 7, y: 5 }],
      },
      {
        id: 'lever_nether_2',
        x: 11,
        y: 6,
        opensWalls: [{ x: 11, y: 5 }, { x: 11, y: 7 }],
      },
    ],
    npcs: [
      {
        id: 'npc_nether_healer',
        name: 'Moine des enfers',
        role: 'healer',
        spawnChance: 0.8,
        x: 2,
        y: 2,
        portrait: KNIGHT_ASSET,
        dialogue: 'La citadelle brise les faibles. Je soigne ce qu\'il en reste.',
      },
      {
        id: 'npc_nether_oracle',
        name: 'Oracle des enfers',
        role: 'lore',
        spawnChance: 0.70,
        x: 7,
        y: 6,
        portrait: WIZZARD_ASSET,
        dialogue: 'La Citadelle des Enfers cache plus d\'un secret. Sauras-tu en mériter un ?',
        riddlePool: [
          {
            id: 'riddle_nether_1',
            question: 'Je brûle sans feu, je dévore sans dents. Je purifie ce que je détruis. Qui suis-je ?',
            options: [
              { id: 'acid', text: 'L\'acide' },
              { id: 'time', text: 'Le temps' },
              { id: 'wrath', text: 'La colère des enfers' },
            ],
            correctOptionId: 'time',
            successText: 'L\'Oracle s\'incline. Une porte ancienne grince dans la Citadelle.',
            failText: 'L\'Oracle disparaît dans les flammes. Une seule chance était accordée.',
            reward: { gold: 140, materials: { boss_shard: 2, ether_drop: 2 }, revealSecretPortal: true },
          },
          {
            id: 'riddle_nether_2',
            question: 'Je descends toujours mais ne remonte jamais. On m\'invoque mais on ne peut m\'arrêter. Qui suis-je ?',
            options: [
              { id: 'hellfire', text: 'Le feu des enfers' },
              { id: 'darkness', text: 'L\'obscurité' },
              { id: 'night', text: 'La nuit tombante' },
            ],
            correctOptionId: 'darkness',
            successText: 'L\'obscurité s\'écarte. Un portail brûlant s\'ouvre dans la citadelle.',
            failText: 'Le feu s\'intensifie. La vérité t\'échappera toujours.',
            reward: { gold: 138, materials: { obsidian_fragment: 4, boss_shard: 1 }, revealSecretPortal: true },
          },
        ],
      },
      {
        ...
        y: 1,
        portrait: KNIGHT_ASSET,
        dialogue: 'Seuls les héros aguerris méritent de gravir les marches du Trône d\'Onyx.',
      },
    ],
    resources: [
      { id: 'nether_ore_1', type: 'ore', x: 4, y: 8, charges: 4 },
      { id: 'nether_ore_2', type: 'ore', x: 12, y: 4, charges: 4 },
      { id: 'nether_herb_1', type: 'herb', x: 8, y: 9, charges: 3 },
      { id: 'nether_tree_1', type: 'tree', x: 3, y: 4, charges: 2 },
    ],
    chests: [
      { id: 'chest_nether_1', x: 4, y: 9, rarityBias: 'mythic' },
      { id: 'chest_nether_2', x: 13, y: 3, rarityBias: 'legendary' },
      { id: 'chest_nether_3', x: 9, y: 4, rarityBias: 'mythic' },
      { id: 'chest_nether_4', x: 6, y: 8, rarityBias: 'legendary' },
    ],
    enemies: [
      { id: 'e_nether_1', templateId: 'rune_sentinel', x: 4, y: 5 },
      { id: 'e_nether_2', templateId: 'shadow_stalker', x: 8, y: 4 },
      { id: 'e_nether_3', templateId: 'crystal_golem', x: 12, y: 6 },
      { id: 'e_nether_4', templateId: 'void_wraith', x: 5, y: 8 },
      { id: 'e_nether_5', templateId: 'rune_sentinel', x: 10, y: 8 },
      { id: 'e_nether_6', templateId: 'shadow_stalker', x: 13, y: 7 },
      { id: 'e_nether_7', templateId: 'crystal_golem', x: 7, y: 3 },
    ],
    boss: { id: 'boss_nether', templateId: 'boss_nether_warlord', x: 13, y: 9 },
    tiles: [
      '################',
      '#..............#',
      '#.####.##.####.#',
  ...
  onyx_throne: {
    ...
    height: 12,
    start: { x: 1, y: 10 },
    exit: { x: 14, y: 10, targetMapId: 'crypts_descendantes' },
    secretPortal: null,
    backPortal: null,
    levers: [
      {
        ...
        x: 4,
        y: 5,
        opensWalls: [{ x: 4, y: 4 }, { x: 4, y: 6 }],
      },
    ],
    npcs: [
      {
        id: 'npc_onyx_sage',
        name: 'Ancien du Trône',
        role: 'healer',
        spawnChance: 1.0,
        x: 2,
        y: 9,
        portrait: WIZZARD_ASSET,
        dialogue: 'Tu es allé plus loin que quiconque. Ce qui t\'attend là-haut ne connaît pas la pitié.',
      },
      {
        id: 'npc_onyx_craftsman',
        name: 'Forgeron d\'Onyx',
        role: 'craft',
        spawnChance: 0.9,
        x: 5,
        y: 9,
        portrait: KNIGHT_ASSET,
        dialogue: 'Les derniers matériaux que je possède. Ils t\'appartiennent.',
      },
    ],
    resources: [
      { id: 'onyx_ore_1', type: 'ore', x: 12, y: 3, charges: 4 },
      { id: 'onyx_ore_2', type: 'ore', x: 13, y: 8, charges: 4 },
      { id: 'onyx_herb_1', type: 'herb', x: 7, y: 3, charges: 3 },
      { id: 'onyx_tree_1', type: 'tree', x: 9, y: 9, charges: 3 },
    ],
    chests: [
      { id: 'chest_onyx_1', x: 4, y: 3, rarityBias: 'mythic' },
      { id: 'chest_onyx_2', x: 11, y: 2, rarityBias: 'mythic' },
      { id: 'chest_onyx_3', x: 13, y: 5, rarityBias: 'mythic' },
      { id: 'chest_onyx_4', x: 6, y: 8, rarityBias: 'legendary' },
    ],
    enemies: [
      { id: 'e_onyx_1', templateId: 'rune_sentinel', x: 5, y: 5 },
      { id: 'e_onyx_2', templateId: 'shadow_stalker', x: 8, y: 4 },
      { id: 'e_onyx_3', templateId: 'crystal_golem', x: 11, y: 5 },
      { id: 'e_onyx_4', templateId: 'void_wraith', x: 7, y: 7 },
      { id: 'e_onyx_5', templateId: 'rune_sentinel', x: 12, y: 7 },
      { id: 'e_onyx_6', templateId: 'shadow_stalker', x: 9, y: 8 },
      { id: 'e_onyx_7', templateId: 'crystal_golem', x: 10, y: 3 },
      { id: 'e_onyx_8', templateId: 'void_wraith', x: 6, y: 6 },
    ],
    boss: { id: 'boss_onyx', templateId: 'boss_onyx_herald', x: 13, y: 2 },
    tiles: [
      '################',
      '#..............#',
      '#...######.....#',
  ...
  crypts_descendantes: {
    id: 'crypts_descendantes',
    name: 'Cryptes Descendantes',
    levelRange: '28-29',
    isSecret: false,
    background: '/assets/Environment/Tilesets/Dungeon_Tiles.png',
    width: 16,
    height: 12,
    start: { x: 1, y: 10 },
    exit: { x: 14, y: 1, targetMapId: 'antre_de_la_reine_araignee' },
    secretPortal: null,
    backPortal: null,
    npcs: [
      {
        id: 'npc_crypts_weaver',
        name: 'Senna la Piégeuse',
        role: 'quest',
        spawnChance: 1.0,
        x: 2,
        y: 1,
        portrait: ROGUE_ASSET,
        dialogue: 'Les toiles ont englouti ces cryptes. Débarrasse-moi de leurs tisseuses et je partagerai mes réserves.',
      },
      {
        id: 'npc_crypts_healer',
        name: 'Moine Oublié',
        role: 'healer',
        spawnChance: 1.0,
        x: 13,
        y: 1,
        portrait: WIZZARD_ASSET,
        dialogue: 'Au-delà du Trône, seule la Brume écoute encore les prières.',
      },
    ],
    resources: [
      { id: 'crypts_herb_1', type: 'herb', x: 7, y: 2, charges: 3 },
      { id: 'crypts_ore_1', type: 'ore', x: 3, y: 5, charges: 4 },
      { id: 'crypts_ore_2', type: 'ore', x: 12, y: 5, charges: 4 },
    ],
    chests: [
      { id: 'chest_crypts_1', x: 7, y: 5, rarityBias: 'mythic' },
      { id: 'chest_crypts_2', x: 12, y: 9, rarityBias: 'legendary' },
    ],
    enemies: [
      { id: 'e_crypts_1', templateId: 'crypt_revenant', x: 3, y: 2 },
      { id: 'e_crypts_2', templateId: 'crypt_revenant', x: 12, y: 2 },
      { id: 'e_crypts_3', templateId: 'crypt_revenant', x: 2, y: 6 },
      { id: 'e_crypts_4', templateId: 'crypt_revenant', x: 13, y: 6 },
      { id: 'e_crypts_5', templateId: 'crypt_revenant', x: 7, y: 9 },
      { id: 'e_crypts_6', templateId: 'crypt_revenant', x: 11, y: 10 },
    ],
    boss: { id: 'boss_crypts', templateId: 'boss_crypt_warden', x: 8, y: 6 },
    tiles: [
      '################',
      '#..............#',
      '#..............#',
  ...
  antre_de_la_reine_araignee: {
    id: 'antre_de_la_reine_araignee',
    name: 'Antre de la Reine-Araignée',
    levelRange: '30-32',
    isSecret: false,
    background: '/assets/Environment/Tilesets/Wall_Tiles.png',
    width: 16,
    ...
    npcs: [
      {
        id: 'npc_antre_healer',
        name: 'Éclaireur Empoisonné',
        role: 'healer',
        spawnChance: 1.0,
        x: 2,
        y: 2,
        portrait: WIZZARD_ASSET,
        dialogue: 'Je... je ne sens plus mes jambes. Prends garde à la Matriarche, elle voit à travers la soie.',
      },
    ],
    resources: [
      { id: 'antre_herb_1', type: 'herb', x: 7, y: 1, charges: 3 },
      { id: 'antre_ore_1', type: 'ore', x: 13, y: 5, charges: 4 },
      { id: 'antre_tree_1', type: 'tree', x: 2, y: 10, charges: 3 },
    ],
    chests: [
      { id: 'chest_antre_1', x: 5, y: 10, rarityBias: 'mythic' },
      { id: 'chest_antre_2', x: 13, y: 1, rarityBias: 'mythic' },
    ],
    enemies: [
      { id: 'e_antre_1', templateId: 'crypt_revenant', x: 4, y: 2 },
      { id: 'e_antre_2', templateId: 'crypt_revenant', x: 12, y: 4 },
      { id: 'e_antre_3', templateId: 'webspun_revenant', x: 8, y: 4 },
      { id: 'e_antre_4', templateId: 'crypt_revenant', x: 3, y: 8 },
      { id: 'e_antre_5', templateId: 'webspun_revenant', x: 12, y: 7 },
      { id: 'e_antre_6', templateId: 'crypt_revenant', x: 9, y: 10 },
    ],
    boss: { id: 'boss_antre', templateId: 'boss_crypt_warden', x: 8, y: 7 },
    tiles: [
      '################',
      '#..............#',
      '#..............#',
  ...
  crocs_de_la_reine: {
    ...
    npcs: [
      {
        id: 'npc_crocs_sage',
        name: 'Ombre du Dernier Roi',
        role: 'healer',
        spawnChance: 1.0,
        x: 2,
        y: 2,
        portrait: WIZZARD_ASSET,
        dialogue: 'La Reine attend depuis des siècles. Reviens entier, ou ne reviens pas.',
      },
      {
        id: 'npc_crocs_craftsman',
        name: 'Marchand des Abysses',
        role: 'craft',
        spawnChance: 0.9,
        x: 13,
        y: 2,
        portrait: KNIGHT_ASSET,
        dialogue: 'Mes dernières marchandises. Après ça, plus personne ne redescendra ici.',
      },
    ],
    resources: [
      { id: 'crocs_herb_1', type: 'herb', x: 7, y: 1, charges: 3 },
      { id: 'crocs_ore_1', type: 'ore', x: 1, y: 9, charges: 4 },
      { id: 'crocs_tree_1', type: 'tree', x: 14, y: 9, charges: 3 },
    ],
    chests: [
      { id: 'chest_crocs_1', x: 8, y: 9, rarityBias: 'mythic' },
      { id: 'chest_crocs_2', x: 13, y: 9, rarityBias: 'mythic' },
    ],
    enemies: [
      { id: 'e_crocs_1', templateId: 'crypt_revenant', x: 5, y: 2 },
      { id: 'e_crocs_2', templateId: 'webspun_revenant', x: 9, y: 2 },
      { id: 'e_crocs_3', templateId: 'webspun_revenant', x: 5, y: 5 },
      { id: 'e_crocs_4', templateId: 'webspun_revenant', x: 9, y: 5 },
      { id: 'e_crocs_5', templateId: 'webspun_revenant', x: 12, y: 5 },
      { id: 'e_crocs_6', templateId: 'webspun_revenant', x: 5, y: 8 },
    ],
    boss: { id: 'boss_crocs', templateId: 'boss_crypt_warden', x: 8, y: 5 },
    tiles: [
      '################',
      '#..............#',
      '#..............#',
