...
export const LOOT_BASES = {
  ...
  armor: [
    ...
    { name: 'Cuirasse des ombres', attack: 2, defense: 14, value: 190, icon: '/assets/Weapons/Hands/Hands.png' },
  ],
  trinket: [
    ...
    { name: 'Sceau du vide', attack: 7, defense: 5, value: 210, icon: '/assets/Icons/anneau.png' },
    { name: 'Orbe d\'Onyx', attack: 9, defense: 7, value: 280, icon: '/assets/Icons/anneau.png' },
  ],
}
