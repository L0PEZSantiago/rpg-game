...
const RAW_CLASS_DEFINITIONS = [
  {
    ...
    skills: [
      ...
      },
      {
        ...
        unlockLevel: 4,
        description: 'Déchaîne une déflagration enflammée qui brûle la cible pendant 3 tours.',
        apCost: 3,
        manaCost: 18,
        cooldown: 3,
        effect: 'dot',
      ...
      },
      {
        ...
        unlockLevel: 6,
        description: 'Brûle la cible et peut l\'endormir.',
        apCost: 4,
        manaCost: 24,
        cooldown: 3,
        effect: 'dot',
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        unlockLevel: 2,
        description: 'Adopte une posture défensive : réduit les dégâts du prochain coup à 25%.',
        apCost: 3,
        manaCost: 10,
        cooldown: 3,
        effect: 'guard',
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        name: 'Discordance',
        unlockLevel: 6,
        description: 'Affaiblit l\'armure ennemie et peut terroriser.',
        apCost: 4,
        manaCost: 21,
        cooldown: 3,
        effect: 'debuff',
...
const CLASS_INNATE_PASSIVES = {
  ...
  necromancer: {
    ...
    description: '+12% vol de vie et +12 mana max.',
    bonuses: { lifeStealPercent: 0.12, maxManaFlat: 12 },
  },
  bard: {
...
const SKILL_STATUS_AUGMENTS = {
  ...
  mage_entropy_mark: {
    statusEffect: { kind: 'sleep', chance: 0.22, turns: 2 },
  },
  assassin_blade_fan: {
  ...
  bard_discord: {
    statusEffect: { kind: 'fear', chance: 0.3, turns: 2, fearChance: 0.45 },
  },
}
