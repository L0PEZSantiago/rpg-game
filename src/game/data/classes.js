...
const RAW_CLASS_DEFINITIONS = [
  {
    ...
    skills: [
      {
        ...
        name: 'Eclair runique',
        unlockLevel: 1,
        description: 'Projectile arcanique rapide. Peut être relancé le même tour.',
        apCost: 3,
        manaCost: 14,
        cooldown: 0,
        effect: 'damage',
      ...
      },
      {
        ...
        name: 'Téléportation',
        unlockLevel: 2,
        description: 'Se téléporte hors du combat (50% de chance). 2 tours de recharge.',
        apCost: 2,
        manaCost: 18,
        cooldown: 2,
        effect: 'flee',
      ...
      },
      {
        ...
        unlockLevel: 4,
        description: 'Déflagration enflammée qui brûle la cible pendant 3 tours.',
        apCost: 3,
        manaCost: 18,
        cooldown: 3,
        effect: 'dot',
      ...
      },
      {
        ...
        name: 'Sommeil arcanique',
        unlockLevel: 6,
        description: 'Endort la cible pendant 1 à 2 tours (80% de chance, 65% sur les boss).',
        apCost: 4,
        manaCost: 24,
        cooldown: 3,
        effect: 'sleep_cast',
        isMagic: true,
        statusEffect: { kind: 'sleep', chance: 0.80, bossChance: 0.65, minTurns: 1, maxTurns: 2 },
      },
      {
        id: 'mage_void_ray',
        name: 'Rayon du vide',
    ...
    passives: [
      ...
      },
      {
        ...
        description: '+12% Dégâts magiques.',
        requires: 'mana_well',
        bonuses: { magicDamagePercent: 0.12 },
      },
      {
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        name: 'Pas de l\'ombre',
        unlockLevel: 2,
        description: 'Augmente l\'esquive de 2 pendant 2 tours.',
        apCost: 2,
        manaCost: 13,
        cooldown: 3,
        effect: 'buff',
      ...
      },
      {
        ...
        unlockLevel: 4,
        description: 'Coupe les artères de la cible infligeant un saignement.',
        apCost: 4,
        manaCost: 16,
        cooldown: 2,
        effect: 'dot',
    ...
    passives: [
      ...
      },
      {
        ...
        description: '+4% esquive.',
        requires: 'venom_edge',
        bonuses: { dodgeChanceFlat: 0.04 },
      },
      {
        ...sharedPassives.soul_pulse,
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        unlockLevel: 2,
        description: 'Posture défensive : prochain coup réduit à 25%, et +25% résistance pendant 2 tours.',
        apCost: 3,
        manaCost: 10,
        cooldown: 3,
        effect: 'guard',
      ...
      },
      {
        ...
        name: 'Brise rempart',
        unlockLevel: 4,
        description: 'Charge violente qui étourdit la cible pendant 1 tour. Une cible étourdie ne peut pas agir.',
        apCost: 3,
        manaCost: 12,
        cooldown: 3,
        effect: 'control',
  ...
  },
  {
    ...
    skills: [
      {
        ...
        name: 'Tir perçant',
        unlockLevel: 1,
        description: 'Tir précis qui ignore une partie de l\'armure ennemie.',
        apCost: 3,
        manaCost: 11,
        cooldown: 0,
        effect: 'damage',
      ...
      {
        id: 'archer_venom_arrow',
        name: 'Flèche vénéneuse',
        unlockLevel: 2,
        description: 'Empoisonne la cible et réduit sa précision.',
        apCost: 3,
        manaCost: 14,
        cooldown: 2,
        effect: 'dot',
      ...
      },
      {
        ...
        name: 'Pas de lynx',
        unlockLevel: 3,
        description: 'Plonge dans l\'ombre : garantit l\'esquive du prochain coup ennemi.',
        apCost: 2,
        manaCost: 12,
        cooldown: 3,
        effect: 'buff',
      ...
      {
        id: 'archer_rain',
        name: 'Barrage de flèches',
        unlockLevel: 4,
        description: 'Déluge de projectiles pouvant étourdir la cible.',
        apCost: 5,
        manaCost: 21,
        cooldown: 3,
        effect: 'damage',
      ...
      },
      {
        ...
        name: 'Mise en joue',
        unlockLevel: 6,
        description: 'Vise avec soin: +50% critique pendant 2 tours.',
        apCost: 2,
        manaCost: 15,
        cooldown: 3,
        effect: 'buff',
      ...
      },
      {
        ...
        name: 'Tir fatal',
        unlockLevel: 8,
        description: 'Flèche mortelle, dégâts amplifiés sur les cibles affaiblies.',
        apCost: 6,
        manaCost: 28,
        cooldown: 4,
        effect: 'execute',
    ...
    passives: [
      ...
      },
      {
        id: 'hunter_stride',
        tier: 2,
        name: 'Chasseur venimeux',
        description: '+12% dégâts sur la durée (poison/saignement).',
        requires: 'falcon_eyes',
        bonuses: { dotPercent: 0.12 },
      },
      {
        id: 'critical_draw',
        tier: 3,
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        name: 'Discordance',
        unlockLevel: 2,
        description: 'Affaiblit l\'armure ennemie et peut terroriser la cible.',
        apCost: 4,
        manaCost: 21,
        cooldown: 3,
        effect: 'debuff',
      ...
      },
      {
        ...
        unlockLevel: 4,
        description: '+25% d\'attaque pendant 2 tours.',
        apCost: 3,
        manaCost: 17,
        cooldown: 3,
        effect: 'buff',
...
const CLASS_INNATE_PASSIVES = {
  mage: {
    ...
    description: '+6 mana/tour et +8% Dégâts critiques.',
    bonuses: { manaRegenFlat: 6, critDamageFlat: 0.08 },
  },
  druid: {
  ...
  necromancer: {
    ...
    description: '+12% vol de vie et +25 mana max.',
    bonuses: { lifeStealPercent: 0.12, maxManaFlat: 25 },
  },
  bard: {
    id: 'innate_battle_rhythm',
    name: 'Rythme de bataille',
    description: '+6 mana/tour et +10% efficacité des soins.',
    bonuses: { manaRegenFlat: 6, healingDonePercent: 0.1 },
  },
}
...
const SKILL_STATUS_AUGMENTS = {
  ...
  warrior_charge: {
    statusEffect: { kind: 'stun', chance: 0.75, turns: 1 },
  },
  archer_venom_arrow: {
    statusEffect: { kind: 'disorient', chance: 0.3, turns: 1, value: 1 },
  },
  archer_rain: {
    statusEffect: { kind: 'stun', chance: 0.28, turns: 1 },
  },
  necro_plague: {
    statusEffect: { kind: 'weaken', chance: 0.35, turns: 2, value: 0.12 },
  },
  necro_oblivion: {
    statusEffect: { kind: 'fear', chance: 0.32, turns: 2, fearChance: 0.5 },
  },
  bard_discord: {
    statusEffect: { kind: 'fear', chance: 0.65, minTurns: 1, maxTurns: 3, fearChance: 0.5 },
  },
}
